...
<body>
	<h1>java54formitup Person List+</h1>
    ...
    <form:form action='/personplus/${person.id}/edit' method='post' modelAttribute='person'>
	
	<form:hidden value="${person.id}" path="id"/>
